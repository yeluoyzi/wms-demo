<template>
  <div>
    <div style="margin-bottom: 10px;">
      ...
      <el-button type="primary" style="margin-left: 5px;" @click="add" v-if="user.roleId==0">新增</el-button>
    </div>
    <el-table :data="tableData"
      ...
      <el-table-column prop="operate" label="操作" >
        <template slot-scope="scope">
          <el-button size="mini" type="success" @click="edit(scope.row)" v-if="user.roleId==0">编辑</el-button>

          <el-popconfirm
              title="确定删除吗？" style="margin-left: 5px" @confirm="de(scope.row.id)">
            <el-button slot="reference" size="mini" type="danger" v-if="user.roleId==0">删除</el-button>
          </el-popconfirm>
